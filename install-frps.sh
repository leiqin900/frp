...
export FRPS_INIT="https://raw.githubusercontent.com/leiqin900/frp/master/frps.init"
...
str_install_shell="https://raw.githubusercontent.com/leiqin900/frp/master/install-frps.sh"
shell_update(){
    fun_clangcn "clear"
